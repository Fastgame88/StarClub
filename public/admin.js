...
function offerForm(o={}){
  ...
  return `<form id="offerForm" class="form-grid offer-editor">
    ...
    <div class="admin-help">Заповніть або <b>код товару 1С</b> для одного товару, або <b>код/назву групи 1С</b> для всієї групи.</div>
...
async function challenges(editId=null){
  ...
  content.innerHTML=`<div class="card editor-card ${edit?'edit-panel':''}"><h3>${edit?'Редагувати челендж':'Створити челендж'}</h3>
    <form id="challengeForm" class="form-grid">
      ...
      <label class="admin-field"><span>Код або назва групи товарів з 1С</span><input name="category" placeholder="Наприклад: ЦБ000001210 або bakery" value="${esc(edit?.category||'')}"></label>
